...
var $author$project$Types$initModel = {bytes: $elm$core$Array$empty, comments: $elm$core$Dict$empty, confirmQuit: false, converterInput: '', converterMode: $elm$core$Maybe$Nothing, dirty: false, editError: $elm$core$Maybe$Nothing, editType: $elm$core$Maybe$Nothing, editingComment: $elm$core$Maybe$Nothing, editingInstruction: $elm$core$Maybe$Nothing, editingLabel: $elm$core$Maybe$Nothing, editingMajorComment: $elm$core$Maybe$Nothing, fileName: '', gotoError: false, gotoInput: '', gotoMode: false, helpExpanded: false, jumpHistory: _List_Nil, labels: $elm$core$Dict$empty, loadAddress: 0, majorComments: $elm$core$Dict$empty, mark: $elm$core$Maybe$Nothing, outlineMode: false, outlineSelection: 0, patches: $elm$core$Dict$empty, regions: _List_Nil, restartPoints: $elm$core$Set$empty, segments: _List_Nil, selectedOffset: $elm$core$Maybe$Nothing, symbols: $elm$core$Dict$empty, variableAddress: '', variableListMode: false, variableListSelection: 0, variableMode: $elm$core$Maybe$Nothing, variableName: '', viewLines: 25, viewStart: 0};
...
var $author$project$Main$CancelConverter = {$: 'CancelConverter'};
...
var $author$project$Main$CancelVariable = {$: 'CancelVariable'};
var $author$project$Main$CancelVariableList = {$: 'CancelVariableList'};
...
var $author$project$Main$ConfirmVariableAddress = {$: 'ConfirmVariableAddress'};
var $author$project$Types$DecToHex = {$: 'DecToHex'};
var $author$project$Main$DeleteSelectedVariable = {$: 'DeleteSelectedVariable'};
var $author$project$Types$EditByte = {$: 'EditByte'};
var $author$project$Types$EditInstruction = {$: 'EditInstruction'};
var $author$project$Types$EditText = {$: 'EditText'};
var $author$project$Main$EnterDecToHexMode = {$: 'EnterDecToHexMode'};
var $author$project$Main$EnterGotoMode = {$: 'EnterGotoMode'};
var $author$project$Main$EnterHexToDecMode = {$: 'EnterHexToDecMode'};
var $author$project$Main$EnterOutlineMode = {$: 'EnterOutlineMode'};
var $author$project$Main$EnterVariableListMode = {$: 'EnterVariableListMode'};
var $author$project$Main$EnterVariableMode = {$: 'EnterVariableMode'};
var $author$project$Types$EnteringAddress = {$: 'EnteringAddress'};
var $author$project$Types$EnteringName = {$: 'EnteringName'};
...
var $author$project$Types$HexToDec = {$: 'HexToDec'};
...
var $author$project$Main$SaveVariable = {$: 'SaveVariable'};
var $author$project$Main$SelectNextLine = {$: 'SelectNextLine'};
var $author$project$Main$SelectPrevLine = {$: 'SelectPrevLine'};
var $author$project$Main$StartEditByte = function (a) {
	return {$: 'StartEditByte', a: a};
};
var $author$project$Main$StartEditComment = function (a) {
	return {$: 'StartEditComment', a: a};
};
var $author$project$Main$StartEditInstruction = function (a) {
	return {$: 'StartEditInstruction', a: a};
};
...
var $author$project$Main$StartEditText = function (a) {
	return {$: 'StartEditText', a: a};
};
...
var $author$project$Main$VariableListNext = {$: 'VariableListNext'};
var $author$project$Main$VariableListPrev = {$: 'VariableListPrev'};
...
var $author$project$Assembler$BranchOutOfRange = function (a) {
	return {$: 'BranchOutOfRange', a: a};
};
var $elm$core$Basics$modBy = _Basics_modBy;
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Assembler$encodeInstruction = F4(
	function (currentAddress, opcode, mode, operand) {
		switch (mode.$) {
			case 'Implied':
			...
			case 'Absolute':
				var lo = A2($elm$core$Basics$modBy, 256, operand);
				var hi = (operand / 256) | 0;
				return $elm$core$Result$Ok(
					{
						bytes: _List_fromArray(
							[opcode, lo, hi]),
			...
			default:
				var nextAddr = currentAddress + 2;
				var offset = operand - nextAddr;
				if ((_Utils_cmp(offset, -128) < 0) || (offset > 127)) {
					return $elm$core$Result$Err(
						$author$project$Assembler$BranchOutOfRange(offset));
				} else {
					var signedByte = (offset < 0) ? (256 + offset) : offset;
					return $elm$core$Result$Ok(
						{
							bytes: _List_fromArray(
								[opcode, signedByte]),
...
var $author$project$Assembler$addressingModeToInt = function (mode) {
	switch (mode.$) {
		case 'Implied':
			return 0;
		case 'Accumulator':
...
var $author$project$Assembler$opcodeList = _List_fromArray(
	[
		_Utils_Tuple2('BRK', $author$project$Types$Implied),
		_Utils_Tuple2('ORA', $author$project$Types$IndirectX),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('SLO', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ORA', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ASL', $author$project$Types$ZeroPage),
		_Utils_Tuple2('SLO', $author$project$Types$ZeroPage),
		_Utils_Tuple2('PHP', $author$project$Types$Implied),
		_Utils_Tuple2('ORA', $author$project$Types$Immediate),
		_Utils_Tuple2('ASL', $author$project$Types$Accumulator),
		_Utils_Tuple2('ANC', $author$project$Types$Immediate),
		_Utils_Tuple2('NOP', $author$project$Types$Absolute),
		_Utils_Tuple2('ORA', $author$project$Types$Absolute),
		_Utils_Tuple2('ASL', $author$project$Types$Absolute),
		_Utils_Tuple2('SLO', $author$project$Types$Absolute),
		_Utils_Tuple2('BPL', $author$project$Types$Relative),
		_Utils_Tuple2('ORA', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('SLO', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ORA', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ASL', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SLO', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('CLC', $author$project$Types$Implied),
		_Utils_Tuple2('ORA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('SLO', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ORA', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ASL', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('SLO', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('JSR', $author$project$Types$Absolute),
		_Utils_Tuple2('AND', $author$project$Types$IndirectX),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('RLA', $author$project$Types$IndirectX),
		_Utils_Tuple2('BIT', $author$project$Types$ZeroPage),
		_Utils_Tuple2('AND', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ROL', $author$project$Types$ZeroPage),
		_Utils_Tuple2('RLA', $author$project$Types$ZeroPage),
		_Utils_Tuple2('PLP', $author$project$Types$Implied),
		_Utils_Tuple2('AND', $author$project$Types$Immediate),
		_Utils_Tuple2('ROL', $author$project$Types$Accumulator),
		_Utils_Tuple2('ANC', $author$project$Types$Immediate),
		_Utils_Tuple2('BIT', $author$project$Types$Absolute),
		_Utils_Tuple2('AND', $author$project$Types$Absolute),
		_Utils_Tuple2('ROL', $author$project$Types$Absolute),
		_Utils_Tuple2('RLA', $author$project$Types$Absolute),
		_Utils_Tuple2('BMI', $author$project$Types$Relative),
		_Utils_Tuple2('AND', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('RLA', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('AND', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ROL', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('RLA', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SEC', $author$project$Types$Implied),
		_Utils_Tuple2('AND', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('RLA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('AND', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ROL', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('RLA', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('RTI', $author$project$Types$Implied),
		_Utils_Tuple2('EOR', $author$project$Types$IndirectX),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('SRE', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPage),
		_Utils_Tuple2('EOR', $author$project$Types$ZeroPage),
		_Utils_Tuple2('LSR', $author$project$Types$ZeroPage),
		_Utils_Tuple2('SRE', $author$project$Types$ZeroPage),
		_Utils_Tuple2('PHA', $author$project$Types$Implied),
		_Utils_Tuple2('EOR', $author$project$Types$Immediate),
		_Utils_Tuple2('LSR', $author$project$Types$Accumulator),
		_Utils_Tuple2('ALR', $author$project$Types$Immediate),
		_Utils_Tuple2('JMP', $author$project$Types$Absolute),
		_Utils_Tuple2('EOR', $author$project$Types$Absolute),
		_Utils_Tuple2('LSR', $author$project$Types$Absolute),
		_Utils_Tuple2('SRE', $author$project$Types$Absolute),
		_Utils_Tuple2('BVC', $author$project$Types$Relative),
		_Utils_Tuple2('EOR', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('SRE', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('EOR', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('LSR', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SRE', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('CLI', $author$project$Types$Implied),
		_Utils_Tuple2('EOR', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('SRE', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('EOR', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('LSR', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('SRE', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('RTS', $author$project$Types$Implied),
		_Utils_Tuple2('ADC', $author$project$Types$IndirectX),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('RRA', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ADC', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ROR', $author$project$Types$ZeroPage),
		_Utils_Tuple2('RRA', $author$project$Types$ZeroPage),
		_Utils_Tuple2('PLA', $author$project$Types$Implied),
		_Utils_Tuple2('ADC', $author$project$Types$Immediate),
		_Utils_Tuple2('ROR', $author$project$Types$Accumulator),
		_Utils_Tuple2('ARR', $author$project$Types$Immediate),
		_Utils_Tuple2('JMP', $author$project$Types$Indirect),
		_Utils_Tuple2('ADC', $author$project$Types$Absolute),
		_Utils_Tuple2('ROR', $author$project$Types$Absolute),
		_Utils_Tuple2('RRA', $author$project$Types$Absolute),
		_Utils_Tuple2('BVS', $author$project$Types$Relative),
		_Utils_Tuple2('ADC', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('RRA', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ADC', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ROR', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('RRA', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SEI', $author$project$Types$Implied),
		_Utils_Tuple2('ADC', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('RRA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ADC', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ROR', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('RRA', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('NOP', $author$project$Types$Immediate),
		_Utils_Tuple2('STA', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$Immediate),
		_Utils_Tuple2('SAX', $author$project$Types$IndirectX),
		_Utils_Tuple2('STY', $author$project$Types$ZeroPage),
		_Utils_Tuple2('STA', $author$project$Types$ZeroPage),
		_Utils_Tuple2('STX', $author$project$Types$ZeroPage),
		_Utils_Tuple2('SAX', $author$project$Types$ZeroPage),
		_Utils_Tuple2('DEY', $author$project$Types$Implied),
		_Utils_Tuple2('NOP', $author$project$Types$Immediate),
		_Utils_Tuple2('TXA', $author$project$Types$Implied),
		_Utils_Tuple2('ANE', $author$project$Types$Immediate),
		_Utils_Tuple2('STY', $author$project$Types$Absolute),
		_Utils_Tuple2('STA', $author$project$Types$Absolute),
		_Utils_Tuple2('STX', $author$project$Types$Absolute),
		_Utils_Tuple2('SAX', $author$project$Types$Absolute),
		_Utils_Tuple2('BCC', $author$project$Types$Relative),
		_Utils_Tuple2('STA', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('SHA', $author$project$Types$IndirectY),
		_Utils_Tuple2('STY', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('STA', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('STX', $author$project$Types$ZeroPageY),
		_Utils_Tuple2('SAX', $author$project$Types$ZeroPageY),
		_Utils_Tuple2('TYA', $author$project$Types$Implied),
		_Utils_Tuple2('STA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('TXS', $author$project$Types$Implied),
		_Utils_Tuple2('TAS', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('SHY', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('STA', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('SHX', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('SHA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('LDY', $author$project$Types$Immediate),
		_Utils_Tuple2('LDA', $author$project$Types$IndirectX),
		_Utils_Tuple2('LDX', $author$project$Types$Immediate),
		_Utils_Tuple2('LAX', $author$project$Types$IndirectX),
		_Utils_Tuple2('LDY', $author$project$Types$ZeroPage),
		_Utils_Tuple2('LDA', $author$project$Types$ZeroPage),
		_Utils_Tuple2('LDX', $author$project$Types$ZeroPage),
		_Utils_Tuple2('LAX', $author$project$Types$ZeroPage),
		_Utils_Tuple2('TAY', $author$project$Types$Implied),
		_Utils_Tuple2('LDA', $author$project$Types$Immediate),
		_Utils_Tuple2('TAX', $author$project$Types$Implied),
		_Utils_Tuple2('LXA', $author$project$Types$Immediate),
		_Utils_Tuple2('LDY', $author$project$Types$Absolute),
		_Utils_Tuple2('LDA', $author$project$Types$Absolute),
		_Utils_Tuple2('LDX', $author$project$Types$Absolute),
		_Utils_Tuple2('LAX', $author$project$Types$Absolute),
		_Utils_Tuple2('BCS', $author$project$Types$Relative),
		_Utils_Tuple2('LDA', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('LAX', $author$project$Types$IndirectY),
		_Utils_Tuple2('LDY', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('LDA', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('LDX', $author$project$Types$ZeroPageY),
		_Utils_Tuple2('LAX', $author$project$Types$ZeroPageY),
		_Utils_Tuple2('CLV', $author$project$Types$Implied),
		_Utils_Tuple2('LDA', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('TSX', $author$project$Types$Implied),
		_Utils_Tuple2('LAS', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('LDY', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('LDA', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('LDX', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('LAX', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('CPY', $author$project$Types$Immediate),
		_Utils_Tuple2('CMP', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$Immediate),
		_Utils_Tuple2('DCP', $author$project$Types$IndirectX),
		_Utils_Tuple2('CPY', $author$project$Types$ZeroPage),
		_Utils_Tuple2('CMP', $author$project$Types$ZeroPage),
		_Utils_Tuple2('DEC', $author$project$Types$ZeroPage),
		_Utils_Tuple2('DCP', $author$project$Types$ZeroPage),
		_Utils_Tuple2('INY', $author$project$Types$Implied),
		_Utils_Tuple2('CMP', $author$project$Types$Immediate),
		_Utils_Tuple2('DEX', $author$project$Types$Implied),
		_Utils_Tuple2('SBX', $author$project$Types$Immediate),
		_Utils_Tuple2('CPY', $author$project$Types$Absolute),
		_Utils_Tuple2('CMP', $author$project$Types$Absolute),
		_Utils_Tuple2('DEC', $author$project$Types$Absolute),
		_Utils_Tuple2('DCP', $author$project$Types$Absolute),
		_Utils_Tuple2('BNE', $author$project$Types$Relative),
		_Utils_Tuple2('CMP', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('DCP', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('CMP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('DEC', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('DCP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('CLD', $author$project$Types$Implied),
		_Utils_Tuple2('CMP', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('DCP', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('CMP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('DEC', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('DCP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('CPX', $author$project$Types$Immediate),
		_Utils_Tuple2('SBC', $author$project$Types$IndirectX),
		_Utils_Tuple2('NOP', $author$project$Types$Immediate),
		_Utils_Tuple2('ISC', $author$project$Types$IndirectX),
		_Utils_Tuple2('CPX', $author$project$Types$ZeroPage),
		_Utils_Tuple2('SBC', $author$project$Types$ZeroPage),
		_Utils_Tuple2('INC', $author$project$Types$ZeroPage),
		_Utils_Tuple2('ISC', $author$project$Types$ZeroPage),
		_Utils_Tuple2('INX', $author$project$Types$Implied),
		_Utils_Tuple2('SBC', $author$project$Types$Immediate),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('SBC', $author$project$Types$Immediate),
		_Utils_Tuple2('CPX', $author$project$Types$Absolute),
		_Utils_Tuple2('SBC', $author$project$Types$Absolute),
		_Utils_Tuple2('INC', $author$project$Types$Absolute),
		_Utils_Tuple2('ISC', $author$project$Types$Absolute),
		_Utils_Tuple2('BEQ', $author$project$Types$Relative),
		_Utils_Tuple2('SBC', $author$project$Types$IndirectY),
		_Utils_Tuple2('JAM', $author$project$Types$Implied),
		_Utils_Tuple2('ISC', $author$project$Types$IndirectY),
		_Utils_Tuple2('NOP', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SBC', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('INC', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('ISC', $author$project$Types$ZeroPageX),
		_Utils_Tuple2('SED', $author$project$Types$Implied),
		_Utils_Tuple2('SBC', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$Implied),
		_Utils_Tuple2('ISC', $author$project$Types$AbsoluteY),
		_Utils_Tuple2('NOP', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('SBC', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('INC', $author$project$Types$AbsoluteX),
		_Utils_Tuple2('ISC', $author$project$Types$AbsoluteX)
	]);
var $elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var $author$project$Assembler$opcodeDict = $elm$core$Dict$fromList(
	$elm$core$List$reverse(
		A2(
			...
			function (_v0) {
				...
				var mnemonic = _v1.a;
				var mode = _v1.b;
				return ((mnemonic !== '???') && (mnemonic !== 'JAM')) ? $elm$core$Maybe$Just(
					_Utils_Tuple2(
						_Utils_Tuple2(
							mnemonic,
							$author$project$Assembler$addressingModeToInt(mode)),
						_byte)) : $elm$core$Maybe$Nothing;
			},
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, $author$project$Assembler$opcodeList))));
var $author$project$Assembler$lookupOpcode = F2(
	function (mnemonic, mode) {
		return A2(
			$elm$core$Dict$get,
			_Utils_Tuple2(
				mnemonic,
				$author$project$Assembler$addressingModeToInt(mode)),
			$author$project$Assembler$opcodeDict);
	});
var $author$project$Assembler$UnknownMnemonic = function (a) {
	return {$: 'UnknownMnemonic', a: a};
};
...
var $author$project$Assembler$InvalidOperand = function (a) {
	return {$: 'InvalidOperand', a: a};
};
...
var $author$project$Assembler$isBranchMnemonic = function (mnemonic) {
	return A2(
...
var $author$project$Assembler$parseHex = function (str) {
	...
	var hexChars = $elm$core$String$toList(
	...
	var folder = F2(
		function (c, acc) {
			...
			if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
				var n = _v0.a.a;
				var d = _v0.b.a;
				return $elm$core$Maybe$Just((n * 16) + d);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		});
	return $elm$core$String$isEmpty(str) ? $elm$core$Maybe$Nothing : A3(
		$elm$core$List$foldl,
		folder,
...
var $author$project$Assembler$parseValue = function (str) {
	var cleaned = $elm$core$String$trim(str);
	return A2($elm$core$String$startsWith, '$', cleaned) ? $author$project$Assembler$parseHex(
		A2($elm$core$String$dropLeft, 1, cleaned)) : $elm$core$String$toInt(cleaned);
};
var $author$project$Assembler$parseDirect = F2(
	function (mnemonic, valueStr) {
		var _v0 = $author$project$Assembler$parseValue(valueStr);
		if (_v0.$ === 'Just') {
			var value = _v0.a;
			return $author$project$Assembler$isBranchMnemonic(mnemonic) ? $elm$core$Result$Ok(
				_Utils_Tuple3(mnemonic, $author$project$Types$Relative, value)) : (((value < 256) && ($elm$core$String$length(
				A2($elm$core$String$filter, $elm$core$Char$isHexDigit, valueStr)) <= 2)) ? $elm$core$Result$Ok(
				_Utils_Tuple3(mnemonic, $author$project$Types$ZeroPage, value)) : $elm$core$Result$Ok(
				_Utils_Tuple3(mnemonic, $author$project$Types$Absolute, value)));
		} else {
			return $elm$core$Result$Err(
				$author$project$Assembler$InvalidOperand(valueStr));
		}
	});
var $author$project$Assembler$OperandOutOfRange = function (a) {
	return {$: 'OperandOutOfRange', a: a};
};
var $author$project$Assembler$parseImmediate = F2(
	function (mnemonic, valueStr) {
		var _v0 = $author$project$Assembler$parseValue(valueStr);
		if (_v0.$ === 'Just') {
			var value = _v0.a;
			return (value < 256) ? $elm$core$Result$Ok(
				_Utils_Tuple3(mnemonic, $author$project$Types$Immediate, value)) : $elm$core$Result$Err(
				$author$project$Assembler$OperandOutOfRange(value));
		} else {
			return $elm$core$Result$Err(
				$author$project$Assembler$InvalidOperand(valueStr));
		}
	});
var $author$project$Assembler$parseIndexed = F2(
	function (mnemonic, operand) {
		var parts = A2(
			$elm$core$List$map,
			$elm$core$String$trim,
			A2($elm$core$String$split, ',', operand));
		_v0$2:
		while (true) {
			if ((parts.b && parts.b.b) && (!parts.b.b.b)) {
				switch (parts.b.a) {
					case 'X':
						var valueStr = parts.a;
						var _v1 = parts.b;
						var _v2 = $author$project$Assembler$parseValue(valueStr);
						if (_v2.$ === 'Just') {
							var value = _v2.a;
							return (value < 256) ? $elm$core$Result$Ok(
								_Utils_Tuple3(mnemonic, $author$project$Types$ZeroPageX, value)) : $elm$core$Result$Ok(
								_Utils_Tuple3(mnemonic, $author$project$Types$AbsoluteX, value));
						} else {
							return $elm$core$Result$Err(
								$author$project$Assembler$InvalidOperand(valueStr));
						}
					case 'Y':
						var valueStr = parts.a;
						var _v3 = parts.b;
						var _v4 = $author$project$Assembler$parseValue(valueStr);
						if (_v4.$ === 'Just') {
							var value = _v4.a;
							return (value < 256) ? $elm$core$Result$Ok(
								_Utils_Tuple3(mnemonic, $author$project$Types$ZeroPageY, value)) : $elm$core$Result$Ok(
								_Utils_Tuple3(mnemonic, $author$project$Types$AbsoluteY, value));
						} else {
							return $elm$core$Result$Err(
								$author$project$Assembler$InvalidOperand(valueStr));
						}
		...
		return $elm$core$Result$Err(
			$author$project$Assembler$InvalidOperand(operand));
	});
...
var $author$project$Assembler$parseIndirect = F2(
	function (mnemonic, operand) {
		if (A2($elm$core$String$endsWith, ',X)', operand)) {
			var valueStr = $elm$core$String$trim(
				A2(
					$elm$core$String$dropRight,
					3,
					A2($elm$core$String$dropLeft, 1, operand)));
			var _v0 = $author$project$Assembler$parseValue(valueStr);
			if (_v0.$ === 'Just') {
				var value = _v0.a;
				return (value < 256) ? $elm$core$Result$Ok(
					_Utils_Tuple3(mnemonic, $author$project$Types$IndirectX, value)) : $elm$core$Result$Err(
					$author$project$Assembler$OperandOutOfRange(value));
			} else {
				return $elm$core$Result$Err(
					$author$project$Assembler$InvalidOperand(valueStr));
			...
			if (A2($elm$core$String$endsWith, '),Y', operand)) {
				var valueStr = $elm$core$String$trim(
					A2(
						$elm$core$String$dropRight,
						3,
						A2($elm$core$String$dropLeft, 1, operand)));
				var _v1 = $author$project$Assembler$parseValue(valueStr);
				if (_v1.$ === 'Just') {
					var value = _v1.a;
					return (value < 256) ? $elm$core$Result$Ok(
						_Utils_Tuple3(mnemonic, $author$project$Types$IndirectY, value)) : $elm$core$Result$Err(
						$author$project$Assembler$OperandOutOfRange(value));
				} else {
					return $elm$core$Result$Err(
						$author$project$Assembler$InvalidOperand(valueStr));
				...
				if (A2($elm$core$String$endsWith, ')', operand)) {
					var valueStr = $elm$core$String$trim(
						A2(
							$elm$core$String$dropRight,
							1,
					...
					if (_v2.$ === 'Just') {
						var value = _v2.a;
						return $elm$core$Result$Ok(
							_Utils_Tuple3(mnemonic, $author$project$Types$Indirect, value));
					} else {
						return $elm$core$Result$Err(
							$author$project$Assembler$InvalidOperand(valueStr));
					}
...
var $author$project$Assembler$parseOperand = F2(
	function (mnemonic, operandStr) {
		var operand = $elm$core$String$trim(operandStr);
		return (operand === 'A') ? $elm$core$Result$Ok(
			_Utils_Tuple3(mnemonic, $author$project$Types$Accumulator, 0)) : (A2($elm$core$String$startsWith, '#', operand) ? A2(
			$author$project$Assembler$parseImmediate,
			mnemonic,
			A2($elm$core$String$dropLeft, 1, operand)) : (A2($elm$core$String$startsWith, '(', operand) ? A2($author$project$Assembler$parseIndirect, mnemonic, operand) : (A2($elm$core$String$contains, ',', operand) ? A2($author$project$Assembler$parseIndexed, mnemonic, operand) : A2($author$project$Assembler$parseDirect, mnemonic, operand))));
	});
...
var $author$project$Assembler$parseInstruction = function (input) {
	var parts = $elm$core$String$words(input);
	if (!parts.b) {
		return $elm$core$Result$Err(
			$author$project$Assembler$UnknownMnemonic(''));
	} else {
		if (!parts.b.b) {
			var mnemonic = parts.a;
			return $elm$core$Result$Ok(
				_Utils_Tuple3(mnemonic, $author$project$Types$Implied, 0));
		} else {
			if (!parts.b.b.b) {
				var mnemonic = parts.a;
				var _v1 = parts.b;
				var operandStr = _v1.a;
				return A2($author$project$Assembler$parseOperand, mnemonic, operandStr);
			} else {
				return A2(
					$author$project$Assembler$parseOperand,
					A2(
...
var $author$project$Assembler$InvalidAddressingMode = F2(
	function (a, b) {
		return {$: 'InvalidAddressingMode', a: a, b: b};
	});
...
var $author$project$Assembler$mnemonicExists = function (mnemonic) {
	return A2(
		$elm$core$List$any,
		function (_v0) {
			var m = _v0.a;
			return _Utils_eq(m, mnemonic);
		},
		$author$project$Assembler$opcodeList);
};
...
var $author$project$Assembler$tryAlternativeModes = F4(
	function (currentAddress, mnemonic, mode, operand) {
		var tryMode = function (m) {
			return A2(
				$elm$core$Maybe$andThen,
				function (op) {
					return $elm$core$Result$toMaybe(
						A4($author$project$Assembler$encodeInstruction, currentAddress, op, m, operand));
				},
				A2($author$project$Assembler$lookupOpcode, mnemonic, m));
		};
		var alternatives = function () {
			switch (mode.$) {
				case 'ZeroPage':
					return _List_fromArray(
						[$author$project$Types$Absolute]);
				case 'Absolute':
					return (operand < 256) ? _List_fromArray(
						[$author$project$Types$ZeroPage]) : _List_Nil;
				case 'ZeroPageX':
					return _List_fromArray(
						[$author$project$Types$AbsoluteX]);
				case 'AbsoluteX':
					return (operand < 256) ? _List_fromArray(
						[$author$project$Types$ZeroPageX]) : _List_Nil;
				case 'ZeroPageY':
					return _List_fromArray(
						[$author$project$Types$AbsoluteY]);
				case 'AbsoluteY':
					return (operand < 256) ? _List_fromArray(
						[$author$project$Types$ZeroPageY]) : _List_Nil;
				default:
					return _List_Nil;
			}
		}();
		var _v0 = A2($elm$core$List$filterMap, tryMode, alternatives);
		if (_v0.b) {
			var result = _v0.a;
			return $elm$core$Result$Ok(result);
		} else {
			return $author$project$Assembler$mnemonicExists(mnemonic) ? $elm$core$Result$Err(
				A2($author$project$Assembler$InvalidAddressingMode, mnemonic, mode)) : $elm$core$Result$Err(
				$author$project$Assembler$UnknownMnemonic(mnemonic));
		}
	});
var $author$project$Assembler$assemble = F2(
	function (currentAddress, input) {
		var cleaned = $elm$core$String$toUpper(
			$elm$core$String$trim(input));
		var _v0 = $author$project$Assembler$parseInstruction(cleaned);
		if (_v0.$ === 'Err') {
			var err = _v0.a;
			...
			var mode = _v1.b;
			var operand = _v1.c;
			var _v2 = A2($author$project$Assembler$lookupOpcode, mnemonic, mode);
			if (_v2.$ === 'Nothing') {
				return A4($author$project$Assembler$tryAlternativeModes, currentAddress, mnemonic, mode, operand);
			} else {
				var opcode = _v2.a;
				return A4($author$project$Assembler$encodeInstruction, currentAddress, opcode, mode, operand);
			}
		}
	});
...
var $author$project$Project$currentVersion = 6;
...
var $author$project$Project$toSaveDataWithPatches = F8(
	function (version, fileName, loadAddress, comments, labels, regions, segments, majorComments) {
		return {comments: comments, fileName: fileName, labels: labels, loadAddress: loadAddress, majorComments: majorComments, patches: _List_Nil, regions: regions, segments: segments, symbols: _List_Nil, version: version};
	});
...
var $author$project$Project$decodeV5 = A2(
	...
	A9(
		...
		A3(
			...
			$elm$json$Json$Decode$list($author$project$Project$decodeMajorComment),
			_List_Nil)));
var $author$project$Project$decodeSymbol = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
	A2($elm$json$Json$Decode$field, 'address', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
var $author$project$Project$decodeV6 = A2(
	$elm$json$Json$Decode$andThen,
	function (partial) {
		return A2(
			$elm$json$Json$Decode$map,
			...
			A3(
				$author$project$Project$optionalField,
				'symbols',
				$elm$json$Json$Decode$list($author$project$Project$decodeSymbol),
				_List_Nil));
	},
	A2(
		$elm$json$Json$Decode$andThen,
...
var $author$project$Project$decoderForVersion = function (version) {
	switch (version) {
		...
		case 6:
			return $author$project$Project$decodeV6;
		default:
...
var $author$project$Disassembler$formatByteWithSymbol = F2(
	function (addr, userSymbols) {
		var _v0 = A2($elm$core$Dict$get, addr, userSymbols);
		if (_v0.$ === 'Just') {
			var sym = _v0.a;
			return sym;
		} else {
			var _v1 = $author$project$Symbols$getSymbol(addr);
			if (_v1.$ === 'Just') {
				var sym = _v1.a;
				return sym;
			} else {
...
var $author$project$Disassembler$formatWordWithSymbol = F2(
	function (addr, userSymbols) {
		var _v0 = A2($elm$core$Dict$get, addr, userSymbols);
		if (_v0.$ === 'Just') {
			var sym = _v0.a;
...
var $author$project$Disassembler$formatOperandWithSymbols = F4(
	function (mode, operand, instrAddress, userSymbols) {
		switch (mode.$) {
			case 'Implied':
				return '';
			case 'Accumulator':
			...
			case 'ZeroPage':
				return A2($author$project$Disassembler$formatByteWithSymbol, operand, userSymbols);
			case 'ZeroPageX':
				return A2($author$project$Disassembler$formatByteWithSymbol, operand, userSymbols) + ',X';
			case 'ZeroPageY':
				return A2($author$project$Disassembler$formatByteWithSymbol, operand, userSymbols) + ',Y';
			case 'Absolute':
				return A2($author$project$Disassembler$formatWordWithSymbol, operand, userSymbols);
			case 'AbsoluteX':
				return A2($author$project$Disassembler$formatWordWithSymbol, operand, userSymbols) + ',X';
			case 'AbsoluteY':
				return A2($author$project$Disassembler$formatWordWithSymbol, operand, userSymbols) + ',Y';
			case 'Indirect':
				return '(' + (A2($author$project$Disassembler$formatWordWithSymbol, operand, userSymbols) + ')');
			case 'IndirectX':
				return '(' + (A2($author$project$Disassembler$formatByteWithSymbol, operand, userSymbols) + ',X)');
			...
			default:
				...
				return A2($author$project$Disassembler$formatWordWithSymbol, target, userSymbols);
		}
	});
var $author$project$Disassembler$formatInstruction = F4(
	function (info, operand, address, userSymbols) {
		var operandStr = A4($author$project$Disassembler$formatOperandWithSymbols, info.mode, operand, address, userSymbols);
...
var $author$project$Disassembler$disassembleLine = F9(
	function (loadAddress, offset, bytes, comments, labels, regions, segments, majorComments, userSymbols) {
		...
		if (_v0.$ === 'Nothing') {
			...
			if (A2($author$project$Disassembler$isInTextRegion, offset, regions)) {
				...
				if (A2($author$project$Disassembler$isInByteRegion, offset, regions)) {
					...
					var disasm = A4($author$project$Disassembler$formatInstruction, info, operandValue, address, userSymbols);
					return {
						address: address,
						bytes: instrBytes,
						comment: A2($elm$core$Dict$get, offset, comments),
...
var $author$project$Disassembler$disassemble = F9(
	function (loadAddress, offset, bytes, comments, labels, regions, segments, majorComments, userSymbols) {
		return A9($author$project$Disassembler$disassembleLine, loadAddress, offset, bytes, comments, labels, regions, segments, majorComments, userSymbols);
	});
...
var $author$project$Project$encodeSymbol = function (_v0) {
	var addr = _v0.a;
	var name = _v0.b;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'symbols',
				A2($elm$json$Json$Encode$list, $author$project$Project$encodeSymbol, data.symbols))
			]));
};
...
var $author$project$Main$formatAssembleError = function (err) {
	switch (err.$) {
		case 'UnknownMnemonic':
			var m = err.a;
			return 'Unknown mnemonic: ' + m;
		case 'InvalidOperand':
			var o = err.a;
			return 'Invalid operand: ' + o;
		case 'InvalidAddressingMode':
			var m = err.a;
			return 'Invalid addressing mode for ' + m;
		case 'OperandOutOfRange':
			var v = err.a;
			return 'Operand out of range: ' + $elm$core$String$fromInt(v);
		default:
			var o = err.a;
			return 'Branch out of range: ' + ($elm$core$String$fromInt(o) + ' bytes');
	}
};
...
var $author$project$Project$fromModel = function (model) {
	return {
		...
		segments: A2(
			...
			model.segments),
		symbols: $elm$core$Dict$toList(model.symbols),
...
var $author$project$Main$parseHex = function (str) {
	...
	return $elm$core$String$isEmpty(cleaned) ? $elm$core$Maybe$Nothing : A2(
		...
		return _Utils_update(
			model,
			{
				...
				segments: A2(
					...
					data.segments),
				symbols: $elm$core$Dict$fromList(data.symbols)
			});
	});
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'KeyPressed':
					var event = msg.a;
					if ((!_Utils_eq(model.editingComment, $elm$core$Maybe$Nothing)) || ((!_Utils_eq(model.editingLabel, $elm$core$Maybe$Nothing)) || ((!_Utils_eq(model.editingMajorComment, $elm$core$Maybe$Nothing)) || (!_Utils_eq(model.editingInstruction, $elm$core$Maybe$Nothing))))) {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						if (model.gotoMode) {
							var _v24 = event.key;
							...
							if (!_Utils_eq(model.converterMode, $elm$core$Maybe$Nothing)) {
								var _v25 = event.key;
								switch (_v25) {
									case 'Escape':
										var $temp$msg = $author$project$Main$CancelConverter,
											$temp$model = model;
										msg = $temp$msg;
										model = $temp$model;
										continue update;
									case 'Backspace':
										return _Utils_Tuple2(
											_Utils_update(
												model,
												{
													converterInput: A2($elm$core$String$dropRight, 1, model.converterInput)
												}),
											$elm$core$Platform$Cmd$none);
									default:
										var key = _v25;
										if ($elm$core$String$length(key) === 1) {
											var _v26 = model.converterMode;
											if (_v26.$ === 'Just') {
												if (_v26.a.$ === 'DecToHex') {
													var _v27 = _v26.a;
													return $elm$core$Char$isDigit(
														A2(
															$elm$core$Maybe$withDefault,
															_Utils_chr(' '),
															A2(
																...
																$elm$core$String$uncons(key)))) ? _Utils_Tuple2(
														_Utils_update(
															model,
															{
																converterInput: _Utils_ap(model.converterInput, key)
															}),
														$elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
												} else {
													var _v28 = _v26.a;
													...
													return isHex ? _Utils_Tuple2(
														_Utils_update(
															model,
															{
																converterInput: _Utils_ap(model.converterInput, _char)
															}),
														$elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
												}
											} else {
								...
								if (!_Utils_eq(model.variableMode, $elm$core$Maybe$Nothing)) {
									var _v29 = event.key;
									switch (_v29) {
										case 'Escape':
											var $temp$msg = $author$project$Main$CancelVariable,
												$temp$model = model;
											msg = $temp$msg;
											model = $temp$model;
											continue update;
										case 'Enter':
											var _v30 = model.variableMode;
											if (_v30.$ === 'Just') {
												if (_v30.a.$ === 'EnteringAddress') {
													var _v31 = _v30.a;
													var $temp$msg = $author$project$Main$ConfirmVariableAddress,
														$temp$model = model;
													msg = $temp$msg;
													model = $temp$model;
													continue update;
													...
													var _v32 = _v30.a;
													var $temp$msg = $author$project$Main$SaveVariable,
														$temp$model = model;
													msg = $temp$msg;
													model = $temp$model;
													continue update;
										...
										case 'Backspace':
											var _v33 = model.variableMode;
											if (_v33.$ === 'Just') {
												if (_v33.a.$ === 'EnteringAddress') {
													var _v34 = _v33.a;
													return _Utils_Tuple2(
														_Utils_update(
															model,
															{
																variableAddress: A2($elm$core$String$dropRight, 1, model.variableAddress)
															}),
														$elm$core$Platform$Cmd$none);
												} else {
													var _v35 = _v33.a;
													return _Utils_Tuple2(
														_Utils_update(
															model,
															{
																variableName: A2($elm$core$String$dropRight, 1, model.variableName)
															}),
														$elm$core$Platform$Cmd$none);
												}
											} else {
										...
										default:
											var key = _v29;
											if ($elm$core$String$length(key) === 1) {
												var _v36 = model.variableMode;
												if (_v36.$ === 'Just') {
													if (_v36.a.$ === 'EnteringAddress') {
														var _v37 = _v36.a;
														var _char = $elm$core$String$toUpper(key);
														return ($elm$core$Char$isHexDigit(
															A2(
																$elm$core$Maybe$withDefault,
																_Utils_chr(' '),
																A2(
																	$elm$core$Maybe$map,
																	$elm$core$Tuple$first,
																	$elm$core$String$uncons(_char)))) && ($elm$core$String$length(model.variableAddress) < 4)) ? _Utils_Tuple2(
															_Utils_update(
																model,
																{
																	variableAddress: _Utils_ap(model.variableAddress, _char)
																}),
															$elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
													} else {
														var _v38 = _v36.a;
														...
														return ($elm$core$Char$isAlphaNum(_char) || _Utils_eq(
															_char,
															_Utils_chr('_'))) ? _Utils_Tuple2(
															_Utils_update(
																model,
																{
																	variableName: _Utils_ap(model.variableName, key)
																}),
															$elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
													}
												} else {
									...
									if (model.variableListMode) {
										var _v39 = event.key;
										switch (_v39) {
											case 'Escape':
												var $temp$msg = $author$project$Main$CancelVariableList,
													$temp$model = model;
												msg = $temp$msg;
												model = $temp$model;
												continue update;
											case 'ArrowLeft':
												var $temp$msg = $author$project$Main$VariableListPrev,
													$temp$model = model;
												msg = $temp$msg;
												model = $temp$model;
												continue update;
											case 'ArrowRight':
												var $temp$msg = $author$project$Main$VariableListNext,
													$temp$model = model;
												msg = $temp$msg;
												model = $temp$model;
												continue update;
											case 'd':
												var $temp$msg = $author$project$Main$DeleteSelectedVariable,
													$temp$model = model;
												msg = $temp$msg;
												model = $temp$model;
												continue update;
											...
											if (model.confirmQuit) {
												...
												switch (_v41) {
													...
													case 'o':
														...
														continue update;
													case 'j':
														var _v46 = model.selectedOffset;
														if (_v46.$ === 'Just') {
															var offset = _v46.a;
															var line = A9($author$project$Disassembler$disassemble, model.loadAddress, offset, model.bytes, model.comments, model.labels, model.regions, model.segments, model.majorComments, model.symbols);
															var _v47 = line.targetAddress;
															if (_v47.$ === 'Just') {
																var addr = _v47.a;
													...
													case 'Enter':
														...
														if (_v50.$ === 'Just') {
															...
															var inByteRegion = A2(
																...
																model.regions);
															if (inByteRegion) {
																var $temp$msg = $author$project$Main$StartEditByte(offset),
																	$temp$model = model;
																msg = $temp$msg;
																model = $temp$model;
																continue update;
																...
																if (inTextRegion) {
																	var $temp$msg = $author$project$Main$StartEditText(offset),
																		$temp$model = model;
																	msg = $temp$msg;
																	model = $temp$model;
																	continue update;
																} else {
																	var $temp$msg = $author$project$Main$StartEditInstruction(offset),
																		$temp$model = model;
																	msg = $temp$msg;
																	model = $temp$model;
																	continue update;
													...
													case 'x':
														...
														continue update;
													case 'v':
														var $temp$msg = $author$project$Main$EnterVariableMode,
															$temp$model = model;
														msg = $temp$msg;
														model = $temp$model;
														continue update;
													case 'V':
														var $temp$msg = $author$project$Main$EnterVariableListMode,
															$temp$model = model;
														msg = $temp$msg;
														model = $temp$model;
														continue update;
													case 'd':
														var $temp$msg = $author$project$Main$EnterDecToHexMode,
															$temp$model = model;
														msg = $temp$msg;
														model = $temp$model;
														continue update;
													case 'h':
														var $temp$msg = $author$project$Main$EnterHexToDecMode,
															$temp$model = model;
														msg = $temp$msg;
														model = $temp$model;
														continue update;
				...
				case 'SelectPrevLine':
					...
					if (_v53.$ === 'Just') {
						var offset = _v53.a;
						if (offset > 0) {
							var _v54 = A3($author$project$Main$findInstructionBoundaries, model.bytes, model.regions, offset);
							var currentStart = _v54.a;
							var prevStart = _v54.b;
				...
				case 'MarkSelectionAsBytes':
					var _v56 = _Utils_Tuple2(model.mark, model.selectedOffset);
					if ((_v56.a.$ === 'Just') && (_v56.b.$ === 'Just')) {
						var markOffset = _v56.a.a;
						var cursorOffset = _v56.b.a;
				...
				case 'MarkSelectionAsText':
					var _v57 = _Utils_Tuple2(model.mark, model.selectedOffset);
					if ((_v57.a.$ === 'Just') && (_v57.b.$ === 'Just')) {
						var markOffset = _v57.a.a;
						var cursorOffset = _v57.b.a;
						var startOff = A2($elm$core$Basics$min, markOffset, cursorOffset);
						var endOff = A2($elm$core$Basics$max, markOffset, cursorOffset);
				...
				case 'ClearByteRegion':
					...
					var _v58 = function () {
						var _v59 = model.mark;
						if (_v59.$ === 'Just') {
							var markOffset = _v59.a;
							return _Utils_Tuple2(
								A2($elm$core$Basics$min, markOffset, offset),
								A2($elm$core$Basics$max, markOffset, offset));
						} else {
							return _Utils_Tuple2(offset, offset);
						}
					}();
					var clearStart = _v58.a;
					var clearEnd = _v58.b;
					var newRegions = A2(
						$elm$core$List$concatMap,
						function (r) {
							if (!_Utils_eq(r.regionType, $author$project$Types$ByteRegion)) {
								return _List_fromArray(
									[r]);
							} else {
								if ((_Utils_cmp(r.end, clearStart) < 0) || (_Utils_cmp(r.start, clearEnd) > 0)) {
									return _List_fromArray(
										[r]);
								} else {
									var rightPart = (_Utils_cmp(r.end, clearEnd) > 0) ? _List_fromArray(
										[
											_Utils_update(
											r,
											{start: clearEnd + 1})
										]) : _List_Nil;
									var leftPart = (_Utils_cmp(r.start, clearStart) < 0) ? _List_fromArray(
										[
											_Utils_update(
											r,
											{end: clearStart - 1})
										]) : _List_Nil;
									return _Utils_ap(leftPart, rightPart);
								}
							}
						},
						model.regions);
				...
				case 'ClearTextRegion':
					...
					var clearStart = _v60.a;
					var clearEnd = _v60.b;
					var newRegions = A2(
						$elm$core$List$concatMap,
						function (r) {
							if (!_Utils_eq(r.regionType, $author$project$Types$TextRegion)) {
								return _List_fromArray(
									[r]);
							} else {
								if ((_Utils_cmp(r.end, clearStart) < 0) || (_Utils_cmp(r.start, clearEnd) > 0)) {
				...
				case 'MarkSelectionAsSegment':
					var _v62 = _Utils_Tuple2(model.mark, model.selectedOffset);
					if ((_v62.a.$ === 'Just') && (_v62.b.$ === 'Just')) {
						var markOffset = _v62.a.a;
						var cursorOffset = _v62.b.a;
						var startOff = A2($elm$core$Basics$min, markOffset, cursorOffset);
						var endOff = A2($elm$core$Basics$max, markOffset, cursorOffset);
				...
				case 'UpdateEditMajorComment':
					var text = msg.a;
					var _v64 = model.editingMajorComment;
					if (_v64.$ === 'Just') {
						var _v65 = _v64.a;
						var offset = _v65.a;
						return _Utils_Tuple2(
				...
				case 'SaveMajorComment':
					var _v66 = model.editingMajorComment;
					if (_v66.$ === 'Just') {
						var _v67 = _v66.a;
						var offset = _v67.a;
						var text = _v67.b;
				...
				case 'JumpBack':
					var _v75 = model.jumpHistory;
					if (_v75.b) {
						var prevOffset = _v75.a;
						var rest = _v75.b;
						return _Utils_Tuple2(
							$author$project$Main$ensureSelectionVisible(
								_Utils_update(
				...
				case 'PageUp':
					...
					var _v76 = A3($author$project$Main$findInstructionBoundaries, model.bytes, model.regions, newViewStart);
					var instrStart = _v76.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
				...
				case 'PageDown':
					...
					var _v77 = A3($author$project$Main$findInstructionBoundaries, model.bytes, model.regions, newViewStart);
					var instrStart = _v77.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
						...
						$elm$core$Platform$Cmd$none);
				case 'NopCurrentByte':
					var _v78 = model.selectedOffset;
					if (_v78.$ === 'Just') {
						var offset = _v78.a;
						var _v79 = A2($elm$core$Array$get, offset, model.bytes);
						if (_v79.$ === 'Just') {
							var currentByte = _v79.a;
				...
				case 'StartEditByte':
					...
					var byteValue = A2(
						...
						0,
						A2($elm$core$Array$get, offset, model.bytes));
					var initialText = '$' + A2($author$project$Main$toHex, 2, byteValue);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								editError: $elm$core$Maybe$Nothing,
								editType: $elm$core$Maybe$Just($author$project$Types$EditByte),
								editingInstruction: $elm$core$Maybe$Just(
									_Utils_Tuple2(offset, initialText))
							}),
						A2(
							$elm$core$Task$attempt,
							function (_v80) {
							...
							$elm$browser$Browser$Dom$focus('instruction-input')));
				case 'StartEditText':
					var offset = msg.a;
					var textRegion = $elm$core$List$head(
						A2(
						...
						if (textRegion.$ === 'Just') {
							...
							return A2(
								...
								A2(
									$elm$core$List$map,
									function (b) {
										return A2($author$project$Main$toHex, 2, b);
									},
									A2(
										$elm$core$List$filterMap,
										function (i) {
											return A2($elm$core$Array$get, i, model.bytes);
										},
										A2($elm$core$List$range, tr.start, tr.end))));
						} else {
							return '';
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								editError: $elm$core$Maybe$Nothing,
								editType: $elm$core$Maybe$Just($author$project$Types$EditText),
								editingInstruction: $elm$core$Maybe$Just(
									_Utils_Tuple2(offset, initialText))
							}),
						A2(
							...
							$elm$browser$Browser$Dom$focus('instruction-input')));
				case 'StartEditInstruction':
					var offset = msg.a;
					var line = A9($author$project$Disassembler$disassemble, model.loadAddress, offset, model.bytes, model.comments, model.labels, model.regions, model.segments, model.majorComments, model.symbols);
					var initialText = A2($elm$core$String$startsWith, '*', line.disassembly) ? A2($elm$core$String$dropLeft, 1, line.disassembly) : line.disassembly;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								editError: $elm$core$Maybe$Nothing,
								editType: $elm$core$Maybe$Just($author$project$Types$EditInstruction),
								editingInstruction: $elm$core$Maybe$Just(
									_Utils_Tuple2(offset, initialText))
							}),
						A2(
				...
				case 'UpdateEditValue':
					var text = msg.a;
					var _v84 = model.editingInstruction;
					if (_v84.$ === 'Just') {
						var _v85 = _v84.a;
						var offset = _v85.a;
						return _Utils_Tuple2(
				...
				case 'SaveValue':
					var _v86 = model.editingInstruction;
					if (_v86.$ === 'Just') {
						var _v87 = _v86.a;
						var offset = _v87.a;
						var text = _v87.b;
						...
						var currentLine = A9($author$project$Disassembler$disassemble, model.loadAddress, offset, model.bytes, model.comments, model.labels, model.regions, model.segments, model.majorComments, model.symbols);
						if (_Utils_eq(
							$elm$core$List$head(
								$elm$core$String$words(currentLine.disassembly)),
							$elm$core$Maybe$Just('.byte'))) {
							var _v88 = $author$project$Main$parseHex(text);
							if (_v88.$ === 'Just') {
								var byteValue = _v88.a;
								if (byteValue > 255) {
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												editError: $elm$core$Maybe$Just('Value must be 0-255 ($00-$FF)')
											}),
										$elm$core$Platform$Cmd$none);
								} else {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											editError: $elm$core$Maybe$Just('Invalid hex value')
										}),
									$elm$core$Platform$Cmd$none);
							}
						} else {
							if (_Utils_eq(
								...
								if (textRegion.$ === 'Just') {
									var tr = textRegion.a;
									var regionSize = (tr.end - tr.start) + 1;
									var hexStrings = $elm$core$String$words(text);
									var parsedBytes = A3(
										$elm$core$List$foldr,
										F2(
											function (maybeB, acc) {
												var _v96 = _Utils_Tuple2(maybeB, acc);
												if ((_v96.a.$ === 'Just') && (_v96.b.$ === 'Just')) {
													var b = _v96.a.a;
													var bs = _v96.b.a;
													return (b <= 255) ? $elm$core$Maybe$Just(
														A2($elm$core$List$cons, b, bs)) : $elm$core$Maybe$Nothing;
												} else {
													return $elm$core$Maybe$Nothing;
												}
											}),
										$elm$core$Maybe$Just(_List_Nil),
										A2($elm$core$List$map, $author$project$Main$parseHex, hexStrings));
									if (parsedBytes.$ === 'Just') {
										var newByteList = parsedBytes.a;
										if (!_Utils_eq(
											$elm$core$List$length(newByteList),
											regionSize)) {
											return _Utils_Tuple2(
												_Utils_update(
													model,
													{
														editError: $elm$core$Maybe$Just(
															'Expected ' + ($elm$core$String$fromInt(regionSize) + (' bytes, got ' + $elm$core$String$fromInt(
																$elm$core$List$length(newByteList)))))
													}),
												$elm$core$Platform$Cmd$none);
										} else {
											...
											var _v92 = A3(
												...
												F2(
													function (_v93, _v94) {
														...
														var patches = _v94.b;
														return _Utils_Tuple2(
															A3($elm$core$Array$set, tr.start + idx, _byte, bytes),
															A3($elm$core$Dict$insert, tr.start + idx, _byte, patches));
													}),
												_Utils_Tuple2(model.bytes, model.patches),
												A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, newByteList));
											var updatedBytes = _v92.a;
											var updatedPatches = _v92.b;
											var updatedModel = $author$project$Main$ensureSelectionVisible(
												_Utils_update(
													model,
													{
										...
										return _Utils_Tuple2(
											_Utils_update(
												model,
												{
													editError: $elm$core$Maybe$Just('Invalid hex values (use space-separated bytes like: 48 45 4C 4C 4F)')
												}),
											$elm$core$Platform$Cmd$none);
									}
								} else {
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												editError: $elm$core$Maybe$Just('Text region not found')
											}),
										$elm$core$Platform$Cmd$none);
								}
							} else {
								var currentByte = A2(
									...
									0,
									A2($elm$core$Array$get, offset, model.bytes));
								var oldSize = $author$project$Opcodes$opcodeBytes(currentByte);
								var currentAddress = model.loadAddress + offset;
								var _v97 = A2($author$project$Assembler$assemble, currentAddress, text);
								if (_v97.$ === 'Err') {
									var err = _v97.a;
									return _Utils_Tuple2(
										_Utils_update(
											...
											{
												editError: $elm$core$Maybe$Just(
													$author$project$Main$formatAssembleError(err))
											}),
										$elm$core$Platform$Cmd$none);
								} else {
									var result = _v97.a;
										...
										var _v98 = A3(
											...
											F2(
												function (_v99, _v100) {
													...
													var patches = _v100.b;
													return _Utils_Tuple2(
														A3($elm$core$Array$set, offset + idx, _byte, bytes),
														A3($elm$core$Dict$insert, offset + idx, _byte, patches));
												}),
											_Utils_Tuple2(model.bytes, model.patches),
											A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, result.bytes));
										var newBytes = _v98.a;
										var newPatches = _v98.b;
										var updatedModel = $author$project$Main$ensureSelectionVisible(
											_Utils_update(
												model,
												{
				...
				case 'CancelEditValue':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{editError: $elm$core$Maybe$Nothing, editType: $elm$core$Maybe$Nothing, editingInstruction: $elm$core$Maybe$Nothing}),
						A2(
							$elm$core$Task$attempt,
							function (_v102) {
								return $author$project$Main$FocusResult;
				...
				case 'EnterDecToHexMode':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								converterInput: '',
								converterMode: $elm$core$Maybe$Just($author$project$Types$DecToHex)
							}),
						$elm$core$Platform$Cmd$none);
				case 'EnterHexToDecMode':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								converterInput: '',
								converterMode: $elm$core$Maybe$Just($author$project$Types$HexToDec)
							}),
						$elm$core$Platform$Cmd$none);
				case 'UpdateConverterInput':
					var str = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'CancelConverter':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{converterInput: '', converterMode: $elm$core$Maybe$Nothing}),
						A2(
							$elm$core$Task$attempt,
							function (_v104) {
								return $author$project$Main$FocusResult;
							...
							$elm$browser$Browser$Dom$focus('cdis-main')));
				case 'EnterVariableMode':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								variableAddress: '',
								variableMode: $elm$core$Maybe$Just($author$project$Types$EnteringAddress),
								variableName: ''
							}),
						$elm$core$Platform$Cmd$none);
				case 'UpdateVariableAddress':
					var str = msg.a;
					var filtered = A2(
						$elm$core$String$filter,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								variableAddress: A2($elm$core$String$left, 4, filtered)
							}),
						$elm$core$Platform$Cmd$none);
				case 'ConfirmVariableAddress':
					var _v105 = $author$project$Main$parseHex(model.variableAddress);
					if (_v105.$ === 'Just') {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									variableMode: $elm$core$Maybe$Just($author$project$Types$EnteringName)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				...
				case 'SaveVariable':
					var _v106 = _Utils_Tuple2(
						$author$project$Main$parseHex(model.variableAddress),
						model.variableName);
					if (_v106.a.$ === 'Just') {
						var addr = _v106.a.a;
						var name = _v106.b;
						return $elm$core$String$isEmpty(name) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
							_Utils_update(
								...
								{
									dirty: true,
									symbols: A3($elm$core$Dict$insert, addr, name, model.symbols),
									variableAddress: '',
									variableMode: $elm$core$Maybe$Nothing,
									variableName: ''
								}),
							A2(
								$elm$core$Task$attempt,
				...
				case 'CancelVariable':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{variableAddress: '', variableMode: $elm$core$Maybe$Nothing, variableName: ''}),
						A2(
							$elm$core$Task$attempt,
							function (_v108) {
								return $author$project$Main$FocusResult;
							...
							$elm$browser$Browser$Dom$focus('cdis-main')));
				case 'EnterVariableListMode':
					return $elm$core$Dict$isEmpty(model.symbols) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{variableListMode: true, variableListSelection: 0}),
						$elm$core$Platform$Cmd$none);
				case 'VariableListNext':
					var maxIdx = $elm$core$Dict$size(model.symbols) - 1;
					var newSelection = A2($elm$core$Basics$min, maxIdx, model.variableListSelection + 1);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{variableListSelection: newSelection}),
						$elm$core$Platform$Cmd$none);
				case 'VariableListPrev':
					var newSelection = A2($elm$core$Basics$max, 0, model.variableListSelection - 1);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{variableListSelection: newSelection}),
						$elm$core$Platform$Cmd$none);
				case 'DeleteSelectedVariable':
					var symbolList = A2(
						$elm$core$List$sortBy,
						$elm$core$Tuple$first,
						$elm$core$Dict$toList(model.symbols));
					var maybeAddr = A2(
						$elm$core$Maybe$map,
						$elm$core$Tuple$first,
						$elm$core$List$head(
							A2($elm$core$List$drop, model.variableListSelection, symbolList)));
					if (maybeAddr.$ === 'Just') {
						var addr = maybeAddr.a;
						var newSymbols = A2($elm$core$Dict$remove, addr, model.symbols);
						var newSelection = A2(
							$elm$core$Basics$max,
							0,
							A2(
								$elm$core$Basics$min,
								model.variableListSelection,
								$elm$core$Dict$size(newSymbols) - 1));
						return $elm$core$Dict$isEmpty(newSymbols) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{dirty: true, symbols: newSymbols, variableListMode: false}),
							A2(
								$elm$core$Task$attempt,
								function (_v110) {
									return $author$project$Main$FocusResult;
							...
							_Utils_update(
								model,
								{dirty: true, symbols: newSymbols, variableListSelection: newSelection}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'CancelVariableList':
					return _Utils_Tuple2(
						_Utils_update(
							model,
										...
										return function (acc) {
											...
											while (true) {
												if ((remaining <= 0) || (_Utils_cmp(
													...
													var line = A9($author$project$Disassembler$disassembleLine, loadAddress, offset, bytes, comments, labels, regions, segments, majorComments, userSymbols);
...
var $author$project$Disassembler$disassembleRange = function (loadAddress) {
					...
					return function (labels) {
						return function (regions) {
							return function (segments) {
								return function (majorComments) {
									return function (userSymbols) {
										return $author$project$Disassembler$disassembleHelper(loadAddress)(startOffset)(count)(bytes)(comments)(labels)(regions)(segments)(majorComments)(userSymbols)(_List_Nil);
									};
								};
							};
						};
...
var $author$project$Main$SaveValue = {$: 'SaveValue'};
var $author$project$Main$UpdateEditValue = function (a) {
	return {$: 'UpdateEditValue', a: a};
};
var $author$project$Main$CancelEditValue = {$: 'CancelEditValue'};
var $author$project$Main$onKeyDownInstruction = A2(
	$elm$html$Html$Events$stopPropagationOn,
	'keydown',
	A2(
		$elm$json$Json$Decode$map,
		function (key) {
			return (key === 'Enter') ? _Utils_Tuple2($author$project$Main$SaveValue, true) : ((key === 'Escape') ? _Utils_Tuple2($author$project$Main$CancelEditValue, true) : _Utils_Tuple2($author$project$Main$NoOp, true));
		},
		A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string)));
...
var $author$project$Main$viewDisasmOrEdit = F2(
	function (model, line) {
		var _v0 = model.editingInstruction;
		if (_v0.$ === 'Just') {
			var _v1 = _v0.a;
			var editOffset = _v1.a;
			var editText = _v1.b;
			return _Utils_eq(editOffset, line.offset) ? A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('col-disasm editing')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$value(editText),
								$elm$html$Html$Events$onInput($author$project$Main$UpdateEditValue),
								$elm$html$Html$Events$onBlur($author$project$Main$SaveValue),
								$author$project$Main$onKeyDownInstruction,
								$elm$html$Html$Attributes$id('instruction-input'),
								$elm$html$Html$Attributes$autofocus(true),
								$elm$html$Html$Attributes$class('instruction-input')
							]),
						_List_Nil),
						function () {
						var _v2 = model.editError;
						if (_v2.$ === 'Just') {
							var err = _v2.a;
							return A2(
								$elm$html$Html$span,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('edit-error')
									]),
								_List_fromArray(
									[
			...
			return A2($author$project$Main$viewDisasm, line, model.labels);
		}
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Main$viewDisasmOrEdit, model, line),
...
var $author$project$Main$viewDisassembly = function (model) {
	...
	var lines = $author$project$Disassembler$disassembleRange(model.loadAddress)(model.viewStart)(model.viewLines)(model.bytes)(model.comments)(model.labels)(model.regions)(model.segments)(model.majorComments)(model.symbols);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$toHexAuto = function (n) {
	return (n <= 255) ? A2($author$project$Main$toHex, 2, n) : ((n <= 65535) ? A2($author$project$Main$toHex, 4, n) : A2($author$project$Main$toHex, 8, n));
};
		...
		if (model.gotoMode) {
			...
			if (!_Utils_eq(model.converterMode, $elm$core$Maybe$Nothing)) {
						...
						if (_v1.a.$ === 'DecToHex') {
							...
							var result = A2(
								...
								A2(
									$elm$core$Maybe$map,
									function (n) {
										return '$' + $author$project$Main$toHexAuto(n);
									},
									$elm$core$String$toInt(model.converterInput)));
							return _Utils_Tuple3('DEC→HEX: ', model.converterInput, result);
						} else {
							var _v3 = _v1.a;
							var result = A2(
								$elm$core$Maybe$withDefault,
								...
								A2(
									...
									$author$project$Main$parseHex(model.converterInput)));
							return _Utils_Tuple3('HEX→DEC: $', model.converterInput, result);
						}
					} else {
						return _Utils_Tuple3('', '', '');
					}
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('cdis-footer goto-mode')
						]),
					_List_fromArray(
						[
							A2(
							...
							$elm$core$String$isEmpty(resultVal) ? A2(
							$elm$html$Html$span,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('goto-hint')
							...
							_List_fromArray(
								[
									$elm$html$Html$text('  = ' + (resultVal + '  (Esc to close)'))
								]))
						]));
			} else {
				if (!_Utils_eq(model.variableMode, $elm$core$Maybe$Nothing)) {
					var _v4 = function () {
						var _v5 = model.variableMode;
						if (_v5.$ === 'Just') {
							if (_v5.a.$ === 'EnteringAddress') {
								var _v6 = _v5.a;
								return _Utils_Tuple3('VAR ADDRESS: $', model.variableAddress, '  (Enter to continue, Esc to cancel)');
							} else {
								var _v7 = _v5.a;
								return _Utils_Tuple3('VAR NAME ($' + (model.variableAddress + '): '), model.variableName, '  (Enter to save, Esc to cancel)');
							}
						} else {
							return _Utils_Tuple3('', '', '');
						}
					...
					if (model.variableListMode) {
						...
						var symbolItems = A2(
							...
							F2(
								function (idx, _v8) {
									var addr = _v8.a;
									var name = _v8.b;
									var itemText = '$' + (A2($author$project$Main$toHex, 4, addr) + ('=' + name));
									var isSelected = _Utils_eq(idx, model.variableListSelection);
						...
						var itemsWithSeparators = A2($elm$core$List$intersperse, separator, symbolItems);
						return A2(
							$elm$html$Html$footer,
							_List_fromArray(
								[
								...
								_Utils_ap(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('  (←→ navigate, d delete, Esc close)')
												]))
										]))));
					} else {
						if (model.outlineMode) {
														...
														[
															...
															_List_fromArray(
																[
																	...
																	$elm$html$Html$text('eXecute in VICE')
																])),
															A2(
															$elm$html$Html$div,
															_List_fromArray(
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$elm$html$Html$text('v / V')
																		])),
																	$elm$html$Html$text('Define / list variables')
																])),
															A2(
															$elm$html$Html$div,
															_List_fromArray(
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$elm$html$Html$text('D / H')
																		])),
																	$elm$html$Html$text('Dec↔Hex converter')
																])),
															A2(
															$elm$html$Html$div,
															_List_fromArray(
									...
									if (_v9.$ === 'Just') {
										switch (_v9.a.$) {
											case 'EditByte':
												...
												return _List_fromArray(
													[
														A2($elm$html$Html$Attributes$style, 'background-color', '#e94560')
													]);
											case 'EditText':
												var _v11 = _v9.a;
												return _List_fromArray(
													[
														A2($elm$html$Html$Attributes$style, 'background-color', '#0f6040')
													]);
											default:
												var _v12 = _v9.a;
												return _List_fromArray(
													[
														A2($elm$html$Html$Attributes$style, 'background-color', '#0f3460')
													]);
										}
									} else {
										return _List_Nil;
										...
										[
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$text('Ctrl+S: Save | '),
